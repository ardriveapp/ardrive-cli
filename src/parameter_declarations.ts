...
export const DriveCreationPrivacyParameters = [UnsafeDrivePasswordParameter, WalletFileParameter, SeedPhraseParameter];
...
Parameter.declare({
	...
	forbiddenConjunctionParameters: [UnsafeDrivePasswordParameter]
});
