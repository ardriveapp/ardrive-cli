...
// function promptForWallet(): string {
...
// function promptForLocalWalletPath(): string {
// 	console.log(
...
// function promptForBackupWalletPath(): string {
...
// export async function promptForLogin(): Promise<string> {
// 	console.log(
// 		'Please enter your ArDrive Login Name.  If no name exists, we will begin to setup a ArDrive Profile for you.'
// 	);
...
// export async function promptForAutoSyncApproval(): Promise<number> {
...
// export async function promptToChangeSyncFolderPath(currentSyncFolderPath: string): Promise<string> {
...
// export async function promptToRemoveDrive(login: string): Promise<string> {
// 	const driveRemoval: string = prompt(
// 		'  Would you like to remove a locally synced Public, Private or Shared Drive? (Default is No) Y/N '
// 	);
...
// export async function promptToAddSharedPublicDrive(user: ArDriveUser): Promise<string> {
...
// export async function promptToAddOrCreatePersonalPrivateDrive(user: ArDriveUser): Promise<string> {
...
// // Asks the user if they want to add or create a new personal private drive
// export async function promptToAddOrCreatePersonalPublicDrive(user: ArDriveUser): Promise<string> {
...
// async function promptForArDriveId(
// 	login: string,
// 	drives: ArFSDriveMetaData[],
// 	drivePrivacy: string
...
// function promptForSyncFolderPath(): string {
...
// export async function promptForNewLoginPassword(): Promise<string> {
// 	let password = '';
// 	console.log(
...
// export async function promptForLoginPassword(): Promise<string> {
...
// export async function promptForNewUserInfo(login: string): Promise<ArDriveUser> {
// 	let wallet;
...
// export async function promptForArDriveUpload(
// 	login: string,
...
// export async function promptForFileOverwrite(filePath: string): Promise<string> {
