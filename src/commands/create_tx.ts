import { ADDR, AR, TxID, W, Winston } from 'ardrive-core-js';
...
new CLICommand({
	...
	action: new CLIAction(async function action(options) {
		...
		const jwkWallet = await parameters.getRequiredWallet();
