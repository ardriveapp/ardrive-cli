...
@test "'ardrive base-reward -h' prints help with all expected fields" {
    ...
    assert_line -n 6 "  --gateway <gateway>  (OPTIONAL) a 'protocol://host:port' formatted string"
    assert_line -n 7 "                       specifying the connection info for the Arweave gateway"
    assert_line -n 8 "                       server to use"
