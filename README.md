...
Arweave wallets can be publicly inspected by their 43-character Arweave wallet address. You can retrieve the wallet address associated with [your wallet file or 12-word seed phrase][kb-wallets] (e.g. wallets generated by [ArConnect][arconnect]) like so:
...
```shell
# Using wallet generated above and example output
...
[ArDrive]'s [ArFS] integration provides for hierarchical organization of your file and folder data.
At the root of every data tree is a "Drive" entity. When a Drive is created, a Root Folder is also created with it.
